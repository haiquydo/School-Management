...
namespace QuanLyTruongHoc
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=D:\\ConsoleApp\\QuanLyTruongHoc\\QuanLyTruongHoc\\QuanLyTruongHoc.mdf;Integrated Security=True");
